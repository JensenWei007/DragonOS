...
impl GenericSignal {
    ...
    pub fn handle_default(&self) {
        match self {
            ...
            Self::SIGRT33 => sig_terminate(*self),
            Self::SIGRT34 => sig_terminate(*self),
            Self::SIGRT35 => sig_terminate(*self),
            Self::SIGRT36 => sig_terminate(*self),
            Self::SIGRT37 => sig_terminate(*self),
            Self::SIGRT38 => sig_terminate(*self),
            Self::SIGRT39 => sig_terminate(*self),
            Self::SIGRT40 => sig_terminate(*self),
            Self::SIGRT41 => sig_terminate(*self),
            Self::SIGRT42 => sig_terminate(*self),
            Self::SIGRT43 => sig_terminate(*self),
            Self::SIGRT44 => sig_terminate(*self),
            Self::SIGRT45 => sig_terminate(*self),
            Self::SIGRT46 => sig_terminate(*self),
            Self::SIGRT47 => sig_terminate(*self),
            Self::SIGRT48 => sig_terminate(*self),
            Self::SIGRT49 => sig_terminate(*self),
            Self::SIGRT50 => sig_terminate(*self),
            Self::SIGRT51 => sig_terminate(*self),
            Self::SIGRT52 => sig_terminate(*self),
            Self::SIGRT53 => sig_terminate(*self),
            Self::SIGRT54 => sig_terminate(*self),
            Self::SIGRT55 => sig_terminate(*self),
            Self::SIGRT56 => sig_terminate(*self),
            Self::SIGRT57 => sig_terminate(*self),
            Self::SIGRT58 => sig_terminate(*self),
            Self::SIGRT59 => sig_terminate(*self),
            Self::SIGRT60 => sig_terminate(*self),
            Self::SIGRT61 => sig_terminate(*self),
            Self::SIGRT62 => sig_terminate(*self),
            Self::SIGRT63 => sig_terminate(*self),
